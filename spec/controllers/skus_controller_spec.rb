...
RSpec.describe SkusController, type: :controller do
  ...
  #       sku = Sku.create! valid_attributes
  #       put :update, params: {id: sku.to_param, sku: new_attributes}
  #       sku.reload
  #       skip("Add assertions for updated state")
  #     end

  #     it "renders a JSON response with the sku" do
  #       sku = Sku.create! valid_attributes

  #       put :update, params: {id: sku.to_param, sku: valid_attributes}
  #       expect(response).to have_http_status(:ok)
  #       expect(response.content_type).to eq('application/json')
  #     end
  #   end
  ...
  #   context "with invalid params" do
  #     it "renders a JSON response with errors for the sku" do
  #       sku = Sku.create! valid_attributes

  #       put :update, params: {id: sku.to_param, sku: invalid_attributes}
  #       expect(response).to have_http_status(:unprocessable_entity)
  #       expect(response.content_type).to eq('application/json')
  #     end
  #   end
  ...
  #     sku = Sku.create! valid_attributes
  #     expect {
  #       delete :destroy, params: {id: sku.to_param}
  #     }.to change(Sku, :count).by(-1)
  #   end
  # end
