...
RSpec.describe ProductCategoriesController, type: :controller do
  ...
  let(:valid_attributes) {
    build(:product_category).attributes
  }
  ...
  #       product_category = ProductCategory.create! valid_attributes
  #       put :update, params: {id: product_category.to_param, product_category: new_attributes}
  ...
  #       put :update, params: {id: product_category.to_param, product_category: valid_attributes}
  ...
  #       put :update, params: {id: product_category.to_param, product_category: invalid_attributes}
  #       expect(response).to have_http_status(:unprocessable_entity)
  #       expect(response.content_type).to eq('application/json')
  #     end
  #   end
  ...
  #     product_category = ProductCategory.create! valid_attributes
  #     expect {
  #       delete :destroy, params: {id: product_category.to_param}
  #     }.to change(ProductCategory, :count).by(-1)
  #   end
  # end
